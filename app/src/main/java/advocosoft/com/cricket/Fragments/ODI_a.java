...
public class ODI_a extends Fragment {
    public static ODI_a mInstance;
    View view;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.fragment_odi_a, container, false);
...
//        ShowMehtod(getActivity(), T20_A.team);
    ...
    public static ODI_a getInstance(){
        return mInstance;
    }
