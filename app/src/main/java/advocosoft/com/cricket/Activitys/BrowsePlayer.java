...
public class BrowsePlayer extends AppCompatActivity {
    ...
    @BindView(R.id.browse_team_toolbar)
    Toolbar browse_team_toolbar;
    @BindView(R.id.recyclerview_browse_team)
    RecyclerView recyclerview_browse_team;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Browse Player");
        ...
        recyclerview_browse_team.setLayoutManager(new LinearLayoutManager(BrowsePlayer.this,LinearLayoutManager.VERTICAL,false));
        browseTeamAdapter = new BrowseTeamAdapter(browseTeamModelArrayList,BrowsePlayer.this);
